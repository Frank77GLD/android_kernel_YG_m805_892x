...
int tcc_ehci_vbus_ctrl(int on)
{
	...
	else if(machine_is_tcc8920st() || machine_is_tcc8930st())
	{
		...
		#if defined(CONFIG_STB_BOARD_HDB892F) || defined(CONFIG_STB_BOARD_YJ8935T) || defined(CONFIG_STB_BOARD_UPC) || defined(CONFIG_STB_BOARD_UPC_TCC893X)
...
int tcc_dwc3_vbus_ctrl(int on)
{
	...
	{	
		...
		//gpio_otg0_vbus_en = TCC_GPEXT2(13); //회로도 보고	
