...
struct sensor_reg* sensor_reg_awb_s5k5caga[5] =
{
...
static int sensor_exposure_s5k5caga(int val)
{
	int val2;
	int val3;
	if((val-20)>= 0)
	...
	val2 = (val-20)/val3;
	return write_regs_s5k5caga(sensor_reg_scene_s5k5caga[val2]);
}
...
void sensor_init_fnc_s5k5caga(SENSOR_FUNC_TYPE *sensor_func)
{
	...
	sensor_func->Set_Exposure			= sensor_exposure_s5k5caga; // 2012.11.23 swhwang insert
