...
static int sensor_exposure_sr130pc10(int val)
{
	int val2;
	int val3;
	if((val-20)>= 0)
	...
	val2 = (val-20)/val3;
	return write_regs_sr130pc10(sensor_reg_scene_sr130pc10[val2]);
}
...
void sensor_info_init_sr130pc10(TCC_SENSOR_INFO_TYPE *sensor_info)
{
	...
	sensor_info->p_clock_pol 				= NEGATIVE_EDGE; //2012.11.23 swhwang
...
void sensor_init_fnc_sr130pc10(SENSOR_FUNC_TYPE *sensor_func)
{
	...
	sensor_func->Set_Exposure			= sensor_exposure_sr130pc10; // 2012.11.23 swhwang insert
