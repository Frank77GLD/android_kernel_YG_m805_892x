...
#define DDICFG_HDMI_AES_HW1			DDICFG_REG(0x24)
#define DDICFG_HDMI_AES_HW2			DDICFG_REG(0x28)
#elif defined(CONFIG_ARCH_TCC88XX ) || defined(CONFIG_MACH_TCC8900 ) || defined( CONFIG_ARCH_TCC92XX)
//@{
/**
 * @name DDI_BUS HDMI_AES register
 */
...
#if defined (CONFIG_ARCH_TCC93XX) || defined(CONFIG_ARCH_TCC893X)
...
#define HDMI_YMAX				HDMIDP_HDMIREG(0x0060)
#define HDMI_YMIN				HDMIDP_HDMIREG(0x0064)
#define HDMI_CMAX				HDMIDP_HDMIREG(0x0068)
#define HDMI_CMIN				HDMIDP_HDMIREG(0x006C)
#define HDMI_HPD_GEN				HDMIDP_HDMIREG(0x0D08)
#else
...
#else
#define HDMI_MPG_CON    			HDMIDP_HDMIREG(0x03a0)
#define HDMI_MPG_CHECK_SUM      		HDMIDP_HDMIREG(0x03b0)
#define HDMI_MPG_BYTE1		        	HDMIDP_HDMIREG(0x03c0)
#define HDMI_MPG_BYTE2	        		HDMIDP_HDMIREG(0x03c4)
#define HDMI_MPG_BYTE3		        	HDMIDP_HDMIREG(0x03c8)
#define HDMI_MPG_BYTE4			        HDMIDP_HDMIREG(0x03cc)
#define HDMI_MPG_BYTE5		        	HDMIDP_HDMIREG(0x03d0)
#endif
//@}
