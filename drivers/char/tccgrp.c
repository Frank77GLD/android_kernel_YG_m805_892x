...
{
#if defined(CONFIG_ARCH_TCC893X)
	free_irq(INT_OVERLAY, &g2d_struct);	
#else
...
#if defined(CONFIG_ARCH_TCC893X)
	if ((ret = request_irq(INT_OVERLAY, tccxxx_grp_handler, IRQF_SHARED, "grp", &g2d_struct))< 0) 	{
