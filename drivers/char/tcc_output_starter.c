...
extern void hdmi_phy_reset_for_vioc(void);
...
#elif defined(CONFIG_MACH_TCC8800ST) || defined(CONFIG_MACH_TCC8920ST)
...
static const unsigned char phy_config[][3][31] = {// TCC8930 HDMI PHY Setting
        ...
        //25.175
    {
        ...
        //27.000
    {
		{0x05, 0x00, 0xD4, 0x10, 0x9C, 0x01, 0xDB, 0x61, 0x10, 0x02, 0x51, 0xDF, 0xF1, 0x51, 0x87, 0x84, 0x00, 0x30, 0x38, 0x00, 0x08, 0x10, 0xE0, /*0x22, 0x40,*/ 0x00,0x40, 0xE3, 0x26, 0x00, 0x00, 0x00, 0x80},
		{0x05, 0x00, 0xD4, 0x10, 0x9C, 0x2D, 0xDB, 0x61, 0x10, 0x02, 0x51, 0xCF, 0xF2, 0x51, 0xA9, 0x84, 0x00, 0x10, 0x38, 0x00, 0xB8, 0x10, 0xE0, /*0x22, 0x40,*/ 0x00,0x40, 0xB5, 0x26, 0x00, 0x00, 0x00, 0x80},
		{0x05, 0x00, 0x10, 0x10, 0x9C, 0xD2, 0x5B, 0x61, 0x10, 0x02, 0x51, 0x2F, 0xF1, 0x51, 0xCB, 0x84, 0x00, 0x10, 0x38, 0x00, 0xA4, 0x10, 0xE0, /*0x22, 0x40,*/ 0x00,0x40, 0x97, 0x26, 0x00, 0x00, 0x00, 0x80},
    },
        //27.027
    {
...
#if defined(CONFIG_ARCH_TCC93XX) || defined(CONFIG_ARCH_TCC88XX) || defined(CONFIG_ARCH_TCC892X) || defined(CONFIG_ARCH_TCC893X)
...
int tcc_hdmi_set_phy_config(const struct HDMIVideoParameter * const hdmi_video_mode)
{
	...
	phy_ready = readb(HDMI_SS_PHY_STATUS_0);
...
static int tcc_hdmi_detect_cable(void)
{
	int ret = true;
		...
		#if defined(CONFIG_TCC_OUTPUT_AUTO_DETECTION) || (defined(TCC_OUTPUT_STARTER_ATTACH) && defined(CONFIG_OUTPUT_ATTACH_DUAL_AUTO) || defined(TCC_OUTPUT_STARTER_DUAL_AUTO))
...
static int tcc_output_starter_load_image(char *filename)
{
	...
	if(pmap_fb.base)
	{
		fb_buf = dst_buf0 = dst_buf1 = (unsigned short *)ioremap_nocache(pmap_fb.base, pmap_fb.size);
...
void tcc_output_starter_component(unsigned char lcdc_num, unsigned char type)
{
	...
	output_height = component_spec.component_lcd_height;
		...
		tcc_output_starter_setport(1, component_spec.component_bus_width);
	#else
		tcc_output_starter_setport(lcdc_num, component_spec.component_bus_width);
	#endif

	tccfb_output_starter(TCC_OUTPUT_COMPONENT, lcdc_num, NULL);
...
int __init tcc_output_starter_init(void)
{
	...
	pmap_get_info("output_attach", &pmap_attach);
		...
		#if defined(CONFIG_ARCH_TCC892X) || defined(CONFIG_ARCH_TCC893X)
			#if defined(TCC_OUTPUT_STARTER_DUAL_AUTO)
			if(tcc_hdmi_detect_cable() == false)
			#else
