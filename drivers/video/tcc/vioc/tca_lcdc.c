...
void tca_lcdc_interrupt_onoff(char onoff, char lcdc)
{
	...
	#define VIOC_DISP_IRQMASK_BIT 	(VIOC_DISP_IREQ_RU_MASK | VIOC_DISP_IREQ_FU_MASK | VIOC_DISP_IREQ_DD_MASK)
#else
	#define VIOC_DISP_IRQMASK_BIT 	(VIOC_DISP_IREQ_RU_MASK)
#endif//
	...
	{
		VIOC_DISP_SetIreqMask(pDISPBase, VIOC_DISP_IRQMASK_BIT, 0);
	}
	else			//VIOC INT dis
	{
		VIOC_DISP_SetIreqMask(pDISPBase, VIOC_DISP_IRQMASK_BIT, VIOC_DISP_IRQMASK_BIT);
	}
