...
static int tcc_gpio_thread(void* _switch_data)
{
	...
	if(machine_is_m805_893x()){
		tcc_gpio_config(TCC_GPE(12), GPIO_FN(0));  // tcc892x : gpio_e(16)
		gpio_request(TCC_GPE(12), "HP_DETECTION");
		gpio_direction_input(TCC_GPE(12));
	}
#endif
	...
	if(machine_is_m805_893x())
	{
		state = gpio_get_value(TCC_GPE(12)); // tcc892x : gpio_e(16)
	}
#endif
