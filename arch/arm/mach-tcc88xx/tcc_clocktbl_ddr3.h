...
{
	{      800000, 147000, 360000,      0,      0,     336000, 297000,      0,      0, 330000 },	// Core 1.20V
	{      800000, 250000, 360000,      0,      0,     336000, 297000,      0,      0, 330000 },	// Core 1.20V
#if 1
	{      800000, 297000, 360000,      0,      0,     336000, 297000,      0,      0, 330000 },	// Core 1.20V	// do not verify for Full HD
#else
	{      0, 297000, 400000,      0,      0,      0,      0,      0,      0, 330000 },	// core 1.32V	// do not verify for Full HD
#endif
};
