...
extern void __init tcc8930st_init_pmic(void);
extern void __init tcc8930st_init_gpio(void);
extern int __init tcc8930st_init_camera(void);
...
static void __init tcc8930_init_machine(void)
{
	...
	else if(system_rev == 0x1008)
	{
		...
		tcc_gpio_config_ext_intr(INT_EINT1, EXTINT_GPIOE_07);
	}
	else
	{
...
MACHINE_START(TCC8930ST, "tcc8930st")
