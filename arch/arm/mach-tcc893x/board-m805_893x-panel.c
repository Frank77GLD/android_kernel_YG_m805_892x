/* linux/arch/arm/mach-tcc893x/board-m805_893x-panel.c
 *
...
static void m805_893x_brightness_set(struct led_classdev *led_cdev, enum led_brightness value)
{
...
static struct led_classdev m805_893x_backlight_led = {
	.name		= "lcd-backlight",
	.brightness	= DEFAULT_BACKLIGHT_BRIGHTNESS,
	.brightness_set	= m805_893x_brightness_set,
};

static int m805_893x_backlight_probe(struct platform_device *pdev)
{
	...
	return led_classdev_register(&pdev->dev, &m805_893x_backlight_led);
}

static int m805_893x_backlight_remove(struct platform_device *pdev)
{
	led_classdev_unregister(&m805_893x_backlight_led);
	return 0;
}

static struct platform_driver m805_893x_backlight_driver = {
	.probe	= m805_893x_backlight_probe,
	.remove	= m805_893x_backlight_remove,
	.driver	= {
		.name	= "m805_893x-backlight",
		.owner	= THIS_MODULE,
	},
};

static struct platform_device m805_893x_backlight = {
	.name = "m805_893x-backlight",
};

int __init m805_893x_init_panel(void)
{
	...
	platform_device_register(&m805_893x_backlight);
	ret = platform_driver_register(&m805_893x_backlight_driver);
	if (ret)
		return ret;
...
device_initcall(m805_893x_init_panel);
