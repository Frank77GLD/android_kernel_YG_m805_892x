...
//    tx			   rx			     rts			cts			  fn
	...
	{TCC_GPF(25), TCC_GPF(26), 			0, 			0, 	GPIO_FN(15)},	// UT_TXD(14)
...
//    tx			   rx			     rts			cts			  fn
	...
	{0, 				0,                  0,                  0, 0}, 					// 9   
	{0, 				0,                  0,                  0, 0}, 					// 10   
	{TCC_GPC(10), TCC_GPC(11),                  0,                  0, GPIO_FN(15)}, // 11   // UT_TXD(11)	
	{TCC_GPE(20), TCC_GPE(18), 			0, 			0, GPIO_FN(15) },	// UT_TXD(12)
	{TCC_GPE(28), TCC_GPE(27), 			0, 			0, GPIO_FN(6)},	// UT_TXD(13)
	{TCC_GPF(25), TCC_GPF(26), 			0, 			0, GPIO_FN(15)},	// UT_TXD(14)
	{TCC_GPC(16), TCC_GPC(17),                  0,                  0, GPIO_FN(7)},  // 12   // UT_TXD(11)		
	{TCC_GPE(13), TCC_GPE(14), TCC_GPE(15), TCC_GPE(16), GPIO_FN(5)},  // 13   // UT_TXD(12)
	{TCC_GPE(20), TCC_GPE(18), 			   0,                  0, GPIO_FN(15)}, // 14    // UT_TXD(12)	
	{TCC_GPE(15), TCC_GPE(16), 			   0,                  0, GPIO_FN(9)}, // 15    // UT_TXD(12)		
	{TCC_GPE(28), TCC_GPE(27),                   0,                  0, GPIO_FN(6)},  // 16   // UT_TXD(13) // GPIO_E28 -> RX?
	{TCC_GPF(13), TCC_GPF(14), TCC_GPF(15), TCC_GPF(16), GPIO_FN(9)},   // 17  // UT_TXD(14) 
	{TCC_GPF(25), TCC_GPF(26),                   0,                  0, GPIO_FN(15)}, // 18    // UT_TXD(14) 	
	{TCC_GPG(11), TCC_GPG(12), TCC_GPG(13), TCC_GPG(14), GPIO_FN(3)},  // 19   // UT_TXD(17)
	{TCC_GPG(15), TCC_GPG(16),                  0,                  0, GPIO_FN(3)},  // 20   // UT_TXD(18)
	{TCC_GPG(17), TCC_GPG(19),                  0,                  0, GPIO_FN(3)},  // 21   // UT_TXD(19)
	{TCC_GPG(15), TCC_GPG(14), TCC_GPG(13), TCC_GPG(12), GPIO_FN(15)},  // 22   // UT_RXD(20) 
	{TCC_GPG(19), TCC_GPG(18), TCC_GPG(17), TCC_GPG(16), GPIO_FN(15)},  // 23   // UT_RXD(20) 
	{TCC_GPG(10), TCC_GPG(9),   TCC_GPG(8),   TCC_GPG(7),  GPIO_FN(3)},  // 24   // UT_RXD(20) 
	{TCC_GPG(14), TCC_GPG(13),                  0,                  0, GPIO_FN(5)},  // 25   // UT_RXD(20) 
	{TCC_GPG(5),  TCC_GPG(6),                    0,                  0, GPIO_FN(3)},  // 26	     // UT_RXD(21) 
	{TCC_GPG(14), TCC_GPG(13),                  0,                  0, GPIO_FN(6)},  // 27	     // UT_RXD(21) 
	{TCC_GPHDMI(2), TCC_GPHDMI(3), TCC_GPHDMI(0), TCC_GPHDMI(1), GPIO_FN(3)},  // 28   // UT_TXD(22)		
	{TCC_GPADC(4), TCC_GPADC(5), TCC_GPADC(3), TCC_GPADC(2), GPIO_FN(2)},    // 29  // UT_TXD(23)
};
#endif
...
{
	if (sc_io.pwren != -1) {
#if defined(CONFIG_MACH_TCC893X) || defined(CONFIG_MACH_TCC8930ST)
...
void tca_sc_init_port(void)
{
	...
	sc_io.pwren = TCC_GPEXT2(7);		//active-low
	sc_io.set_volt = -1;
	sc_io.clk = TCC_GPF(26);
	sc_io.data = TCC_GPF(25);
#endif
	...
	sc_io.detect = TCC_GPC(18);	//active-high
...
int tca_sc_enable(void)
{
	...
	if (uUartCh< 4)
		BITCSET(pPORT->PCFG0.nREG, 0xFF<<(uUartCh*8), uUartPort<<(uUartCh*8));
	else if (uUartCh < 8)
		BITCSET(pPORT->PCFG1.nREG, 0xFF<<((uUartCh-4)*8), uUartPort<<((uUartCh-4)*8));

	dprintk("%s  phy_port = %x \n", __func__, phy_port);

	tcc_gpio_config(uart_port_map[uUartPort][0], uart_port_map[uUartPort][4]);	// TX
	tcc_gpio_config(uart_port_map[uUartPort][1], uart_port_map[uUartPort][4]);	 // RX
