/* linux/arch/arm/mach-tcc893x/board-m805_893x.c
 *
...
#if defined(CONFIG_I2C_TCC_CORE0)
static struct tcc_i2c_platform_data m805_893x_core0_platform_data = {
...
#endif
#if defined(CONFIG_I2C_TCC_CORE1)
static struct tcc_i2c_platform_data m805_893x_core1_platform_data = {
    .core_clk_rate      = 4*1000*1000,    /* core clock rate: 4MHz */
    .core_clk_name      = "i2c1",
    .smu_i2c_flag       = 0,
...
#endif
#if defined(CONFIG_I2C_TCC_CORE2)
static struct tcc_i2c_platform_data m805_893x_core2_platform_data = {
    .core_clk_rate      = 4*1000*1000,    /* core clock rate: 4MHz */
    .core_clk_name      = "i2c2",
    .smu_i2c_flag       = 0,
    .i2c_ch_clk_rate[0] = 400,      /* SCL clock rate : 100kHz */
...
#endif
#if defined(CONFIG_I2C_TCC_CORE3)
static struct tcc_i2c_platform_data m805_893x_core3_platform_data = {
    .core_clk_rate      = 4*1000*1000,    /* core clock rate: 4MHz */
    .core_clk_name      = "i2c3",
    .smu_i2c_flag       = 0,
    .i2c_ch_clk_rate[0] = 80,      /* SCL clock rate : 100kHz */
};
#endif
#if defined(CONFIG_I2C_TCC_SMU)
static struct tcc_i2c_platform_data m805_893x_smu_platform_data = {
    .core_clk_name  = "smu",
    .smu_i2c_flag   = 1,
};
#endif

extern void __init m805_893x_init_pmic(void);
extern void __init m805_893x_init_gpio(void);
extern int __init m805_893x_init_camera(void);

static void __init m805_893x_init_irq(void)
{
    tcc_init_irq();
}
...
static void m805_893x_nand_init(void)
{
...
static int m805_893x_nand_ready(void)
{
	if ( gMultiCS == TRUE )
...
static void m805_893x_SetFlags( int bMultiCS )
{
	gMultiCS = bMultiCS;
...
static struct tcc_nand_platform_data tcc_nand_platdata = {
	...
	.init		= m805_893x_nand_init,
	.ready		= m805_893x_nand_ready,
	.SetFlags	= m805_893x_SetFlags,
};
...
static void __init m805_893x_init_machine(void)
{
	m805_893x_init_pmic();
	m805_893x_init_gpio();
	m805_893x_init_camera();
...
#if defined(CONFIG_I2C_TCC_CORE0)
    platform_device_add_data(&tcc8930_i2c_core0_device, &m805_893x_core0_platform_data, sizeof(struct tcc_i2c_platform_data));
#endif
#if defined(CONFIG_I2C_TCC_CORE1)
    platform_device_add_data(&tcc8930_i2c_core1_device, &m805_893x_core1_platform_data, sizeof(struct tcc_i2c_platform_data));
#endif
#if defined(CONFIG_I2C_TCC_CORE2)
    platform_device_add_data(&tcc8930_i2c_core2_device, &m805_893x_core2_platform_data, sizeof(struct tcc_i2c_platform_data));
#endif
#if defined(CONFIG_I2C_TCC_CORE3)
    platform_device_add_data(&tcc8930_i2c_core3_device, &m805_893x_core3_platform_data, sizeof(struct tcc_i2c_platform_data));
#endif
#if defined(CONFIG_I2C_TCC_SMU)
	platform_device_add_data(&tcc8930_i2c_smu_device, &m805_893x_smu_platform_data, sizeof(struct tcc_i2c_platform_data));
#endif
...
static void __init m805_893x_map_io(void)
{
	tcc_map_common_io();
}

static void __init m805_893x_init_early(void)
{
    tcc_clk_init();
}
