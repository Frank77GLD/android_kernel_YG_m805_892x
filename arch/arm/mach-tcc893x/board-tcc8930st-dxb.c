...
#if defined(CONFIG_STB_BOARD_EV_TCC893X) || defined(CONFIG_STB_BOARD_YJ8935T)
...
static void tcc_dxb_ctrl_power_on(int deviceIdx)
{
    ...
    tcc_gpio_config_ext_intr(INT_EINT3, EXTINT_GPIOG_19);
    err = request_irq(INT_EINT3, isr_checking_ant_overload, IRQ_TYPE_EDGE_FALLING | IRQF_DISABLED, "ANT_OVERLOAD_F", NULL);
    //err = request_irq(INT_EINT3, isr_checking_ant_overload, IRQ_TYPE_EDGE_RISING  | IRQF_DISABLED, "ANT_OVERLOAD_R", NULL);
    if (err)
    {
