...
extern void TCC_LCD_DISPLAY_UPDATE(char hdmi_lcdc, struct tcc_lcdc_image_update *ImageInfo);
...
#endif
extern void TCC_HDMI_DISPLAY_UPDATE_3D(char hdmi_lcdc, struct tcc_lcdc_image_update *ImageInfo);
...
extern void TCC_LCD_SET_OnTheFly(char hdmi_lcdc, struct tcc_lcdc_image_update *ImageInfo);
