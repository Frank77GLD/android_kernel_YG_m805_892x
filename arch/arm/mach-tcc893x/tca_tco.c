...
unsigned IO_TCO_GetGpioFunc(unsigned uCH, unsigned uGPIO)
{
	switch(uGPIO)
	{
		...
		case TCC_GPC(0): 	// TCO0
		case TCC_GPC(1):	// TCO1
		case TCC_GPC(18):	// TCO2 / PWM2
		case TCC_GPC(19):	// TCO3 / PWM3
		case TCC_GPC(20):	// TCO4
		case TCC_GPC(21):	// TCO5
			return GPIO_FN(9);

		case TCC_GPD(9): 	// TCO0 / PWM0
		case TCC_GPD(10):	// TCO1 / PWM1
		case TCC_GPD(11):	// TCO2 / PWM2
		case TCC_GPD(12):	// TCO3 / PWM3
		case TCC_GPD(13):	// TCO4
		case TCC_GPD(14):	// TCO5
			return GPIO_FN(9);

		case TCC_GPE(12): 	// TCO0 / PWM0
		case TCC_GPE(13):	// TCO1 / PWM1
		case TCC_GPE(14):	// TCO2 / PWM2
		case TCC_GPE(15):	// TCO3 / PWM3
		case TCC_GPE(16):	// TCO4
		case TCC_GPE(17):	// TCO5
			return GPIO_FN(7);
			
		case TCC_GPF(16): 	// TCO0 / PWM0
		case TCC_GPF(17):	// TCO1 / PWM1
		case TCC_GPF(18):	// TCO2 / PWM2
		case TCC_GPF(19):	// TCO3 / PWM3
		case TCC_GPF(20):	// TCO4
		case TCC_GPF(21):	// TCO5
			return GPIO_FN(11);	
			
		case TCC_GPG(5): 	// TCO0 / PWM0
		case TCC_GPG(6):	// TCO1 / PWM1
		case TCC_GPG(7):	// TCO2 / PWM2
		case TCC_GPG(8):	// TCO3 / PWM3
		case TCC_GPG(9):	// TCO4 
