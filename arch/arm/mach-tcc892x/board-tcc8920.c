...
#endif
#if defined(CONFIG_PN544_NFC) 
	tcc_gpio_config_ext_intr(INT_EI8, EXTINT_GPIOB_15); // INT_DXB0_IRQ
#endif
...
static void __init tcc8920_init_early(void)
{
    tcc_clk_init();
}
