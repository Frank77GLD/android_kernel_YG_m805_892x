...
#else
#if defined(CONFIG_ARCH_TCC892X) && defined(CONFIG_DRAM_16BIT_USED)
	{ 343750, 189010, 380710,      0, 118735, 167800, 167800,      0,      0 },	// Core 1.10V  (166/166)
	{ 401250, 222860, 456860,      0, 140000, 197860, 197860,      0,      0 },	// Core 1.15V  (182/182)
#else
...
const struct tcc_freq_table_t gtWFDClockLimitTable[] = {
	{ 808000,      0, 600000,      0, 243040,      0,      0, 100000,      0 },	// Core 1.50V
};
...
EXPORT_SYMBOL(gtWFDClockLimitTable);
