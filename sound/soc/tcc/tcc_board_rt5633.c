...
#define TCC893X_M805_GPIOE_17 TCC_GPE(13)
#endif
...
static void hp_mute()
{
	...
	{
		gpio_set_value(TCC893X_M805_GPIOE_17, 0);
	    printk("@@@@@@@@@@@@@@@@@ %s() \n", __func__);
	}
...
static void hp_un_mute()
{
	...
	if(machine_is_m805_893x())
	{
		gpio_set_value(TCC893X_M805_GPIOE_17, 1);
 	    printk("@@@@@@@@@@@@@@@@@ %s() \n", __func__);
	}
...
int tcc_hp_is_valid(void)
{
	...
	if(machine_is_m805_893x())
        // gpio_get_value is ==> 0: disconnect, 1: connect
        return gpio_get_value(TCC893X_M805_GPIOE_17);
#endif
...
static int __init tcc_init_rt5633(void)
{
	...
	tcc_gpio_config(TCC893X_M805_GPIOE_17, GPIO_FN(0));
	gpio_request(TCC893X_M805_GPIOE_17, "HP_MUTE_CTL");
	gpio_direction_output(TCC893X_M805_GPIOE_17, 0);   // HeadPhone mute
